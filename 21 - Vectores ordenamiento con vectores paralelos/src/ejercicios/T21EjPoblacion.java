...
public class T21EjPoblacion {
	...
	public static void main(String[] args) {
		...
		p.seeVectores();
		System.out.println("-------- Con Ordenacion Mayor a Menor----------");
		p.setOrdenacionPoblacionMayorMenor();
		p.seeVectores();
		System.out.println("-------- Con Ordenacion Menor a Mayor----------");
		p.setOrdenacionPoblacionMenorMayor();
		p.seeVectores();
